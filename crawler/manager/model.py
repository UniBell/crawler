...
class OrderBook(db.Model):
    ...
    timestamp = db.Column(db.Date(200), unique = True, nullable = False)
    bids = db.Column(db.Text(1024), unique = True, nullable = False)
    asks = db.Column(db.Text(1024), unique = True, nullable = False)
